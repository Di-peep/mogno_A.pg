...
public class Lab7 {
    ...
    public static void main(String[] args) {
        ...
        Witcher witcher = new Witcher(excalibur);
        witcher.witcherAmunition.add(shapka);
        witcher.witcherAmunition.contains(kurtka);
        witcher.witcherAmunition.remove(0);
        witcher.witcherAmunition.clear();
    ...
    public static class Witcher {     // ЛАБОРАТОРНА 7

        List<Amunition> witcherAmunition = new LinkedList<>();

        public Witcher(Amunition amunition){
            witcherAmunition.add(amunition);
        }
        ...
        public Witcher(ArrayList<Amunition> amw){
            witcherAmunition = amw;
        }
